...
class ec_accountpage{
	...
	private function process_login( ){
		...
		if( $user && $user->user_level == "pending" ){
			...
			if( isset( $_POST['ec_goto_page'] ) && $_POST['ec_goto_page'] != "forgot_password" && $_POST['ec_goto_page'] != "register" && $_POST['ec_goto_page'] != "login" ){
	...
	private function process_update_personal_information( ){
		...
		$success = $this->mysqli->update_personal_information( $old_email, $user_id, $first_name, $last_name, $email, $is_subscriber );
