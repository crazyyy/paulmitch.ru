...
function ec_is_demo_data_writable( ){
	...
	// Test copy of zip
	$zip_download_url = 'http://www.wpeasycart.com/sampledata/standard_demo/standard_clean_assets_V2.zip';	
	$sql_download_url = 'http://www.wpeasycart.com/sampledata/standard_demo/standard_demo_install_V2.sql';	
...
function ec_uninstall_demo_data( ){
	...
	copy( $datapack_url . "/clean_assets_V2.zip",  $install_dir . "clean_assets_V2.zip" );
	...
	// Unzip Products
	$zip = new ZipArchive();
	$zip->open( $install_dir . "clean_assets_V2.zip" );
	...
	$zip->extractTo( $install_dir );
	$zip->close();
	unlink( $install_dir . "clean_assets_V2.zip" );
