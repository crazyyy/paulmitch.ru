...
class ec_admin_options{
	...
	function updateoption( $optionid, $option ){
		...
		if( $option['optiontype'] == 'file' || $option['optiontype'] == 'text' || $option['optiontype'] == 'textarea' || $option['optiontype'] == 'date'  || $option['optiontype'] == 'dimensions1'  || $option['optiontype'] == 'dimensions2' ){
