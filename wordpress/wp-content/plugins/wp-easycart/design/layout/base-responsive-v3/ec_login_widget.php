...
<strong><?php echo $GLOBALS['language']->get_text( 'ec_login_widget', 'hello_text' ); ?>, <?php echo $GLOBALS['ec_user']->first_name; ?></strong> | <a href="<?php echo $account_page; ?>"><?php echo $GLOBALS['language']->get_text( 'ec_login_widget', 'view_account_text' ); ?></a>
