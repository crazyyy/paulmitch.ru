    ...
    <table width='539' border='0' align='center'>
        ...
        <tr>
			...
			<td colspan='4' align='left' class='style22'>
                ...
                <p>
                	<a href="<?php echo $this->account_page . $this->permalink_divider; ?>ec_page=order_details&order_id=<?php echo $this->order_id; ?><?php if( $GLOBALS['ec_cart_data']->cart_data->is_guest != "" && $GLOBALS['ec_cart_data']->cart_data->is_guest ){ ?>&ec_guest_key=<?php echo $GLOBALS['ec_cart_data']->cart_data->guest_key; } ?>" target="_blank">
