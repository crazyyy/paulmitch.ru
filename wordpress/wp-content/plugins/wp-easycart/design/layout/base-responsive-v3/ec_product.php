		...
		<div class="ec_product_quickview_content_padding">
        	<div class="ec_product_quickview_content_holder">
                ...
                <div class="ec_product_quickview_content_data">
                    ...
                    <div class="ec_product_quickview_content_price"><?php if( $product->list_price > 0 ){ ?><span class="ec_list_price"><?php echo $GLOBALS['currency']->get_currency_display( $product->list_price ); ?></span><?php }?><span class="ec_price"><?php echo $GLOBALS['currency']->get_currency_display( $product->price ); if( $product->pricing_per_sq_foot && !get_option( 'ec_option_enable_metric_unit_display' ) ){ echo "/sq ft"; }else if( $product->pricing_per_sq_foot && get_option( 'ec_option_enable_metric_unit_display' ) ){ echo "/sq m"; } ?></div>
                    <?php }?>
	...
	<div style="padding:0px; margin:auto; vertical-align:middle;<?php if( $product_type == 0 ){ ?> display:none;<?php }?>" class="ec_product_type<?php echo $product_type; ?>" id="ec_product_image_<?php echo $product->model_number; ?>">
        ...
        <div class="ec_product_meta_type6">
            ...
            <div class="ec_price_container">
                ...
                <?php }?>
                <span class="ec_price"><?php echo $GLOBALS['currency']->get_currency_display( $product->price ); if( $product->pricing_per_sq_foot && !get_option( 'ec_option_enable_metric_unit_display' ) ){ echo "/sq ft"; }else if( $product->pricing_per_sq_foot && get_option( 'ec_option_enable_metric_unit_display' ) ){ echo "/sq m"; } ?></span>
            </div>
            <?php }?>
        ...
        <div class="ec_price_container_type<?php echo $product_type; ?>">
			<?php if( $product->list_price > 0 ){ ?>
       		...
       		<?php }?>
        	<span class="ec_price_type<?php echo $product_type; ?>"><?php echo $GLOBALS['currency']->get_currency_display( $product->price ); if( $product->pricing_per_sq_foot && !get_option( 'ec_option_enable_metric_unit_display' ) ){ echo "/sq ft"; }else if( $product->pricing_per_sq_foot && get_option( 'ec_option_enable_metric_unit_display' ) ){ echo "/sq m"; } ?></span>
        </div>
        <?php }?>
