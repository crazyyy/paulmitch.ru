...
<div class="single_post">
                ...
                <div class="post_content">
                    ...
                    <div class="single_metainfo"> <?php if(of_get_option('dissauth_checkbox') == "0"){ ?> by <?php the_author(); ?><?php } ?></div>
					...
					<?php if(of_get_option('disscats_checkbox') == "0"){ ?>
                        <div class="post_meta">
     <?php if( has_category() ) { ?><div class="post_cat"><?php _e('Серия' , 'zenon'); ?> : <div class="catag_list"><?php the_category(', '); ?></div></div><?php } ?>
